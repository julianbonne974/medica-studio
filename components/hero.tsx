      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-8">
        <div className="space-y-8 sm:space-y-16">
          ...
          <div className="flex flex-row flex-wrap items-start gap-8 sm:gap-12 lg:gap-16 animate-fade-in-delay-2">
              ...
              <div className="group border-l-4 border-emerald-600 pl-4 sm:pl-6 transition-all hover:border-l-8">
                <div className="space-y-1">
                  <div className="text-4xl sm:text-5xl font-bold text-emerald-600">Web, Mobile, Backend</div>
                  <div className="text-xs sm:text-sm uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Multi-supports</div>
                </div>
              </div>
            </div>
