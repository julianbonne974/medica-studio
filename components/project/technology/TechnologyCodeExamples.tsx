    ...
    <section className="bg-zinc-50 py-16 dark:bg-zinc-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-8">
        ...
        <div className="mb-6 flex flex-wrap gap-2 overflow-x-auto">
          {codeExamples.map((example, index) => (
            <button
              ...
              className={`whitespace-nowrap rounded-none border-2 px-3 py-2 text-xs sm:text-sm font-medium transition-all ${
                activeTab === index
        ...
        <motion.div
          ...
          className="relative overflow-hidden border-2 border-zinc-200 dark:border-zinc-800"
        >
