...
const FlapCell = React.memo(function FlapCell({
  ...
  useEffect(() => {
    ...
    // Accessibilité : pas de scramble/flip si l'utilisateur réduit les animations.
    if (
  ...
  const topBg = accent?.top ?? "bg-neutral-200/80 dark:bg-neutral-800";
  const bottomBg = accent?.bottom ?? "bg-neutral-200/80 dark:bg-neutral-800";
